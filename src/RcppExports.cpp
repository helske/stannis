...
// R_is_correction_global
Rcpp::List R_is_correction_global(const Rcpp::List& model_, const arma::mat& approx_y, const arma::mat approx_var_y, const arma::mat& theta, const arma::vec& approx_posterior, const arma::vec& jacobian, const unsigned int nsim_states, const unsigned int n_threads, const unsigned int seed);
RcppExport SEXP stannis_R_is_correction_global(SEXP model_SEXP, SEXP approx_ySEXP, SEXP approx_var_ySEXP, SEXP thetaSEXP, SEXP approx_posteriorSEXP, SEXP jacobianSEXP, SEXP nsim_statesSEXP, SEXP n_threadsSEXP, SEXP seedSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< const Rcpp::List& >::type model_(model_SEXP);
    ...
    Rcpp::traits::input_parameter< const unsigned int >::type n_threads(n_threadsSEXP);
    Rcpp::traits::input_parameter< const unsigned int >::type seed(seedSEXP);
    rcpp_result_gen = Rcpp::wrap(R_is_correction_global(model_, approx_y, approx_var_y, theta, approx_posterior, jacobian, nsim_states, n_threads, seed));
    return rcpp_result_gen;
END_RCPP
}
